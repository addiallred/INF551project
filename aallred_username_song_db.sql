...
--
-- Host: localhost:3306
-- Generation Time: Apr 02, 2020 at 05:35 PM
...
--
-- Database: `aallred_username_song_db`
--
...
(71, 'Elis Regina-Minha Historia', 41),
...
INSERT INTO `media_types` (`media_type_id`, `name`) VALUES
(1, 'MPEG audio file'),
...
(65, 'Samba De Uma Nota So (One Note Samba)', 8, 1, 2, NULL, 137273, 4535401, 0.99),
...
(205, 'Jorge Da Capadocia', 21, 1, 7, 'Jorge Ben', 177397, 5842196, 0.99),
...
(221, 'Atrás Da Verd-E-Rosa So Não Vai Quem Já Morreu', 21, 1, 7, 'David Corrêa - Paulinho Carvalho - Carlos Sena - Bira do Ponto', 307252, 10364247, 0.99),
...
(335, 'My Love', 29, 1, 9, 'Jauperi/Zeu Goes', 203493, 6772813, 0.99),
...
(407, 'So Tinha De Ser Com Você', 34, 1, 7, 'Vários', 389642, 13085596, 0.99),
...
(562, 'Mangueira', 45, 1, 7, 'Bizuca/Clovis Pê/Gilson Bernini/Marelo D\'Aguia', 298318, 9999506, 0.99),
...
(674, 'Preciso Apender a Viver So (Maysa)', 53, 1, 7, NULL, 143464, 4642359, 0.99),
...
(736, 'Nos (Ao Vivo)', 57, 1, 7, NULL, 193828, 6498661, 0.99),
...
(980, 'Forro De Toquio', 78, 1, 7, NULL, 169273, 5588756, 0.99),
...
(1073, 'oia Eu Aqui De Novo', 85, 1, 10, NULL, 219454, 7469735, 0.99),
...
(1079, 'Qui Nem Jilo', 85, 1, 10, 'Humberto Teixeira/Luiz Gonzaga', 204695, 6937472, 0.99),
...
(1965, 'So Se For Pelo Cabelo', 161, 1, 16, 'Mônica Marianno', 238288, 8006345, 0.99),
...
(2034, 'Farao Divindade Do Egito', 166, 1, 7, NULL, 228571, 7523278, 0.99),
...
(2064, 'Caleidoscopio', 167, 1, 7, 'Herbert Vianna', 256522, 8484597, 0.99),
...
(2077, 'Caleidoscopio', 169, 1, 7, NULL, 211330, 7000017, 0.99),
(2078, 'oculos', 169, 1, 7, NULL, 219271, 7262419, 0.99),
...
(2354, 'Negocio É', 192, 1, 1, NULL, 175464, 5826775, 0.99),
...
(2778, 'Preciso Aprender A Ser So', 223, 1, 7, NULL, 162220, 5213894, 0.99),
...
(3065, 'Ain\'t Talkinbout Love', 243, 1, 1, 'Edward Van Halen, Alex Van Halen, David Lee Roth, Michael Anthony', 228336, 7569506, 0.99),
...
(3084, 'Ain\'t TalkinBout Love', 244, 1, 1, 'Edward Van Halen, Alex Van Halen, Michael Anthony and David Lee Roth', 230060, 7617284, 0.99),
...
(3480, 'Sonata for Solo Violin: IV: Presto', 325, 4, 24, 'Béla Bartok', 299350, 9785346, 0.99),
...
(3485, 'Symphony No. 3 Op. 36 for Orchestra and Soprano \"Symfonia Piesni Zalosnych\"  Lento E Largo - Tranquillissimo', 330, 2, 24, 'Henryk Gorecki', 567494, 9273123, 0.99),
...
--
ALTER TABLE `albums`
  MODIFY `album_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=349;

--
-- AUTO_INCREMENT for table `artists`
--
ALTER TABLE `artists`
  MODIFY `artist_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=276;
...
--
ALTER TABLE `tracks`
  MODIFY `track_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3504;
...
--
ALTER TABLE `tracks`
  ADD CONSTRAINT `tracks_ibfk_1` FOREIGN KEY (`genre_id`) REFERENCES `genres` (`genre_id`),
  ADD CONSTRAINT `tracks_ibfk_2` FOREIGN KEY (`media_type_id`) REFERENCES `media_types` (`media_type_id`),
  ADD CONSTRAINT `tracks_ibfk_3` FOREIGN KEY (`album_id`) REFERENCES `albums` (`album_id`);
COMMIT;
